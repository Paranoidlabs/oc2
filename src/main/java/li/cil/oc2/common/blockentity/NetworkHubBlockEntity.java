...
public final class NetworkHubBlockEntity extends ModBlockEntity implements NetworkInterface {
    ...
    // TODO: Use a BlockCapabilityCache here too
    private void validateAdjacentBlocks() {
        ...
        for (final Direction side : Constants.DIRECTIONS) {
            adjacentBlockInterfaces[side.get3DDataValue()] = level.getCapability(Capabilities.Networked.BLOCK, pos.relative(side), side.getOpposite());
        }
    }
}
