...
public record OpenComputerInventoryMessage(BlockPos pos) implements CustomMessage {

    public static final ResourceLocation ID = new ResourceLocation(API.MOD_ID, "open_computer_inventory");
