...
public final class ModBlockStateProvider extends BlockStateProvider {
    ...
    private static final ResourceLocation VXLAN_HUB_MODEL = new ResourceLocation(API.MOD_ID, "block/vxlan_hub");
    ...
    protected void registerStatesAndModels() {
        ...
        horizontalBlock(Blocks.VXLAN_HUB, Items.VXLAN_HUB, VXLAN_HUB_MODEL);
